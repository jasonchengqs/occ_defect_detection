...
args.model_path = '/home/qisen/Experiments/sdc_exp/mtd_exp/ocnn_exp/model/CAE.pth'
...
test_score = []
test_label = []
for img, lbs in tqdm(val_loader):
    img = img.to(device)
    output = encoder(img)
    # print('out:', output)
    # print('w1', w1)
...
for img, lbs in tqdm(test_loader):
    img = img.to(device)
    output = encoder(img)
    # print('out:', output)
    # print('w1', w1)
