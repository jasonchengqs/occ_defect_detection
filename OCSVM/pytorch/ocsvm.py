...
def parse_args():
    ...
    parser.add_argument('--train_data_path', default='./data/cifar10_cae.npz', type=str, help='path to dataset')
    parser.add_argument('--test_data_path', default='./data/cifar10_cae.npz', type=str, help='path to dataset')    
