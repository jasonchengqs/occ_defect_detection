...
from emdc_dataset import EMDCDataset
...
def load_data(config):
    ...
    elif config['dataset_name'] in ['emdc']:
        data_path = config['emdc_data_path']

        dataset = EMDCDataset(data_path, class_name='D4NG', is_train=True, resize=256, cropsize=224)
        test_set = EMDCDataset(data_path, class_name='D4NG', is_train=False, resize=256, cropsize=224)
